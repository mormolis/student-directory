...
try_load_students
load_students # I would just add this line,  I also changed the load_students to inform the user that the file was loaded successfully and the @students is up to date
interactive_menu